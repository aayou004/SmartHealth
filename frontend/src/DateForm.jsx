...
                                     <md-outlined-text-field class="w-full max-w-xs" id="steps" type="number" value={logData.steps || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Active Minutes" description="Enter the total minutes of physical activity.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="active_minutes" type="number" value={logData.active_minutes || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Workout Type" description="Specify the type of workout (e.g., Running).">
                                    <md-outlined-text-field class="w-full max-w-xs" id="workout_type" value={logData.workout_type || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
...
                                    <md-outlined-text-field class="w-full max-w-xs" id="calorie_intake" type="number" value={logData.calorie_intake || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Glasses of Water" description="Enter the number of water glasses consumed.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="water_glasses" type="number" value={logData.water_glasses || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Protein (g)" description="Enter the total protein intake in grams.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="protein" type="number" value={logData.protein || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Carbs (g)" description="Enter the total carbohydrate intake in grams.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="carbs" type="number" value={logData.carbs || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Fat (g)" description="Enter the total fat intake in grams.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="fat" type="number" value={logData.fat || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
...
                                    <md-outlined-text-field class="w-full max-w-xs" id="mindful_minutes" type="number" value={logData.mindful_minutes || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Hours of Sleep" description="Enter the total hours of sleep.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="sleep_hours" type="number" step="0.1" value={logData.sleep_hours || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Weight" description="Enter your current weight.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="weight" type="number" step="0.1" value={logData.weight || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Resting Heart Rate" description="Enter your resting heart rate in BPM.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="heart_rate" type="number" value={logData.heart_rate || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                                <FormField label="Symptoms" description="List any symptoms experienced today.">
                                    <md-outlined-text-field class="w-full max-w-xs" id="symptoms" value={logData.symptoms || ""} onChange={handleInputChange}></md-outlined-text-field>
                                </FormField>
                            </form>
                        </div>
