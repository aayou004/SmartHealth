...
const Settings = () => {
    ...
    const { setBackgroundImage, backgroundImage, statusMessage, setStatusMessage } = useContext(ThemeContext);
    ...
    const handleImageUpload = (event) => {
        ...
        if (file) {
            ...
            .catch(err => {
                setStatusMessage("Failed to update background.");
    ...
    const handleClearBackground = () => {
        ...
        .then(() => {
            setStatusMessage("Background cleared successfully!");
            setBackgroundImage('');
        ...
        .catch(err => {
            setStatusMessage("Failed to clear background.");
